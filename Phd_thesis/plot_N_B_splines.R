...
GA <- sort( c(rnorm(70,mean=15.5,sd=1),
              rnorm(70,mean=24,sd=1), 
              rnorm(70,mean=33,sd=0.7)) )
...
plot(c(),xlim=range(GA),ylim=c(-0.5,1.5),                            # empty plot
     main="A. Natural splines functions",
...
lines(GA, rowSums(naturalsplinesmx), col = "purple",lwd=2)           # calculate sum of splines and plo
